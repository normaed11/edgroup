...
if($_SERVER["REQUEST_METHOD"] == "GET"){
   // accessing data from URL
    ...
    elseif ($token_get=="" && $email_get !="" && $emailsent == "false"){
        // email function here

        header("location: validate-forgot.php?email=$email_get&emailsent=true");   
    }
...
<body>
    <div class="wrapper">
        <h2>Check your e-mail / Revisa tu correo electronico  </h2><br>
       
            <p>An e-mail has been sent to you. Please click the link on the e-mail to reset  your password.
        </p>
        <br>
            <p>Te enviamos un correo electronico. Favor de dar click a la liga para resetear tu contraseña.
        </p>
<br>
<p id="resend">
    <a href="validate-forgot.php?email=<?php echo $email_get; ?>&emailsent=false">Resend E-mail</a>
</p>
